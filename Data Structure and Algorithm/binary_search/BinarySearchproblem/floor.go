...
//Find the greatest element in among smallest or equal the target
func ceiling(arr []int, target int) int {
	...
	return arr[h] // return next low value, after while loop condtion violated*
}
